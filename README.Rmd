...
Let's say we want to retrieve all ads with 20 impressions from the party "CDU" in Germany:
...
Let's say we want to retrieve all ads which have greater than or equal to one `bct` (which is the behavioural targeting method) in the US:
